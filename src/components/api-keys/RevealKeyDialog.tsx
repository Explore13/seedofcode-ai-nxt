  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent showCloseButton={false} className="sm:max-w-md">
        ...
        <div className="rounded-control border-harvest/40 bg-harvest/10 text-harvest flex items-center gap-2 border px-3 py-2 text-sm">
        ...
        <div className="rounded-control border-border bg-surface-2 flex items-center gap-2 border p-2">
          <code className="text-foreground flex-1 overflow-x-auto px-1 font-mono text-sm whitespace-nowrap">
            {rawKey}
          </code>
